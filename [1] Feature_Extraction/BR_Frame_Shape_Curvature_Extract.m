function [frame] = BR_Frame_Shape_Curvature_Extract(frame, SizeKernel)
    ...
    if frame.isEmpty == 0
        ...
        imObject_BW = frame.object.imageBW_Refined;
        ...
        frame.object.imCurvature = imCurvature;
        frame.object.listCurvature = listCurvature;
        frame.object.imageBW = imObject_BW;
%         figure(233);
        [NumPixels,~] = size(listCurvature);
        frame.object.listCurvature_Normalized = listCurvature./NumPixels;
        
        
%         figure(111);
%         h = histogram(frame.data.listCurvature,'Normalization','probability');
